...
moos_tmpfile=/tmp/jaiabot_${jaia_auv_index}.moos
bhv_tmpfile=/tmp/jaiabot_${jaia_auv_index}.bhv

echo -e "Generating $moos_tmpfile $bhv_tmpfile"
script_dir=$(dirname $0)
python3 ${script_dir}/auv.py moos > $moos_tmpfile
python3 ${script_dir}/auv.py bhv > $bhv_tmpfile
